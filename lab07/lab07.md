...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - Sequence Number: 0
   - Для определения SYN-сегмента можно посомтреть на флаг
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Значение подтверждения в SYN ACK-сегменте определяется путем увеличения порядкового номера из SYN-сегмента на один.
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - номера: 1, 624, 2084, 3544, 5004, 6464
   - 1 - 44.520846814, подтверждение - 44,728300214 = 0,2074534 
   - 624 - 44.521023340, подтверждение - 44.728486740 = 0,2074634 s
   - 2084 - 44.521029943, подтверждение - 44.728486931 = 0.207456988 s
   - 3544 - 44.521087746, подтверждение - 44.728486967 = 0.207399221 s
   - 5004 - 44.521099731, подтверждение -  44.728498953 = 0.207399222 s
   - 6464 - 44.521155080, подтверждение - 44.728487002 = 0.207331922 s
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - winSize / RTT = 64256 / 0.207 = 38 кб/с (примерно)
