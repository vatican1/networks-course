...
#### Демонстрация работы
<img src="images/screenShotTask1.png" width=800 />
...
Проверить многопоточный сервер можно через браузер, запуская там n вкладок, когда они заканчиваются сервер не отвечает, после закрытия одной из рабочих вкладок ответы появляются заново.
